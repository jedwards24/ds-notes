...
Update: it can make a big difference if you have wide data because it avoids the internal `model.frame()` call. I’d be surprised if it was ever slower. Need to check.
