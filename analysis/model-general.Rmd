...
Ordered factors have $N-1$ columns labelled with the variable column name with suffix `.L`, `.Q`, `.C`, `.^4`, `.^5` etc.
...
These can be overridden by supplying a `contrasts` argument.
