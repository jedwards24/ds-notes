...
There is a newer tidyverse package [waldo](https://www.tidyverse.org/blog/2020/10/waldo/) to compare objects but with improved messenging over `testthat::expect_equal()`. I will try this but still perhaps not ideal the larger data frames I've been using.
