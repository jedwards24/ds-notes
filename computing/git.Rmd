...
I learnt a bit about collaborating on a Github project while doing my academic website since the repository is on Rhian’s Github. I can clone it onto my computer as normal but I won’t be able to push changes.

The easiest way and the way we used is for Rhian to add me as a collaborator on GitHub. I can then treat the project as though it is my own. The URL is https://github.com/trianglegirl/james-edwards-website (i.e. still on Rhian’s github), and this is used for cloning and setting up a project in RStudio, but it will be listed in my projects on github.
